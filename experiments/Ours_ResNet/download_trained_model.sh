...
# snapshot directory.
wget http://cvlab.postech.ac.kr/~hyeonwoonoh/research/imageqa/2016_NIPS/Ours_ResNet/save_result_vqa_resnet101_448_test-dev2015.tar.gz
tar -zxvf save_result_vqa_resnet101_448_test-dev2015.tar.gz
rm -rf save_result_vqa_resnet101_448_test-dev2015.tar.gz
