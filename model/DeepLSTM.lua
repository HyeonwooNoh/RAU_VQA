-- This code is brought from the following github repository:
-- https://github.com/VT-vision-lab/VQA_LSTM_CNN
-- modified by Hyeonwoo Noh
--[[
...
function LSTM.create(input_size, rnn_size, n, dropout)
...
--my wrapper
  ...
  return nn.gModule({input, h_old}, {h_new})
end
